...
{
    public abstract class NonNegativeInteger : NonEnumableValueType<int>
    {
        protected override int? ValidateValue(int? value)
        {
            if (value != null && (int)value < 0)
                throw ThrowHelper.New<ArgumentOutOfRangeException>(this, ErrorMessages.NonNegativeIntRequired, value);
